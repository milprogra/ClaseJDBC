...
public class AccesoModulos extends Conexion {
    
    private ResultSet resultado;

    public AccesoModulos() {
        super.conectar();
    }
    ...
    public ResultSet listar(){
        try {
            super.getStmt();
            resultado = stmt.executeQuery("Select * from modulo");
        } catch (SQLException ex) {
            Logger.getLogger(AccesoModulos.class.getName()).log(Level.SEVERE, null, ex);
        }
        return resultado;
    }
